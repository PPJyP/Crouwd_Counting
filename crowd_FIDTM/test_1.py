...
def main(args):
    if args['dataset'] == 'ShanghaiA':
        ...
        test_file = ['./test/images/test_1.jpg']

    if test_file[0].split('.')[2] == 'npy':
...
def pre_data(train_list, args, train):
    ...
    for j in range(len(train_list)):
        ...
        print(fname)
        img = load_data_fidt(Img_path, args, train)
...
def generate_bounding_boxes(kpoint, fname):
    ...
    Img_data = cv2.imread(
        './dataset/ShanghaiTech/part_A_final/test_data/images/' + fname[0])
