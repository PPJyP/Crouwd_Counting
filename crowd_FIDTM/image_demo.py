...
def main(args):
    ...
    # plt.imshow(frame.reshape(frame.shape[1],frame.shape[2],frame.shape[3]))
    ...
    with torch.no_grad():
        ...
        cv2.imwrite('./test/images/demo_1.jpg', res)
        '''write in out_image'''
        plt.imshow('ori_img',res1)
        plt.show()
