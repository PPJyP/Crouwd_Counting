...
shanghai_root = '/content/drive/MyDrive/FIDTM/dataset/ShanghaiTech'
jhu_root = '/content/drive/MyDrive/FIDTM/dataset/jhu_crowd_v2.0'
qnrf_root = '/content/drive/MyDrive/FIDTM/dataset/UCF-QNRF_ECCV18'
...
try:
    ...
    train_list.sort()
    np.save('/content/drive/MyDrive/FIDTM/npydata/ShanghaiA_train.npy', train_list)
    ...
    test_list.sort()
    np.save('/content/drive/MyDrive/FIDTM/npydata/ShanghaiA_test.npy', test_list)
...
try:
    ...
    train_list.sort()
    np.save('/content/drive/MyDrive/FIDTM/npydata/ShanghaiB_train.npy', train_list)
    ...
    test_list.sort()
    np.save('/content/drive/MyDrive/FIDTM/npydata/ShanghaiB_test.npy', test_list)
...
try:
    ...
    train_list.sort()
    np.save('/content/drive/MyDrive/FIDTM/npydata/qnrf_train.npy', train_list)
    ...
    test_list.sort()
    np.save('/content/drive/MyDrive/FIDTM/npydata/qnrf_test.npy', test_list)
...
try:
    ...
    train_list.sort()
    np.save('/content/drive/MyDrive/FIDTM/npydata/jhu_train.npy', train_list)
    ...
    val_list.sort()
    np.save('/content/drive/MyDrive/FIDTM/npydata/jhu_val.npy', val_list)
    ...
    test_list.sort()
    np.save('/content/drive/MyDrive/FIDTM/npydata/jhu_test.npy', test_list)
...
try:
    ...
    root = '/content/drive/MyDrive/FIDTM/dataset/NWPU_localization/images_2048/'
    train_list = []
    for filename in os.listdir(root):
        if filename.split('.')[1] == 'jpg':
            train_list.append(root + filename)
    train_list.sort()
    np.save('/content/drive/MyDrive/FIDTM/npydata/nwpu_train_2048.npy', train_list)

    root = root.replace('images', 'test_data')
    test_list = []
    for filename in os.listdir(root):
        if filename.split('.')[1] == 'jpg':
            test_list.append(root + filename)
    test_list.sort()
    np.save('/content/drive/MyDrive/FIDTM/npydata/nwpu_test_2048.npy', test_list)
    ...
    # np.save('/content/drive/MyDrive/FIDTM/npydata/nwpu_train_2048.npy', train_img_list)

    # val_img_list = []
    # for i in range(len(val_list)):
    #     fname = val_list[i].split(' ')[0] + '.jpg'
    #     val_img_list.append(root + fname)
    # np.save('/content/drive/MyDrive/FIDTM/npydata/nwpu_val_2048.npy', val_img_list)
    ...
    # np.save('/content/drive/MyDrive/FIDTM/npydata/nwpu_test_2048.npy', test_img_list)
